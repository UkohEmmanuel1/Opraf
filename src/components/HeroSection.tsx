  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container text-center px-4 py-20">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary-foreground leading-tight mb-6 animate-slide-up font-serif">
          Building Wealth, Protecting Assets,
          <br className="hidden sm:block" /> Managing Futures.
        </h1>
        <p className="max-w-2xl mx-auto text-lg sm:text-xl text-primary-foreground/80 mb-10 animate-fade-in font-sans" style={{ animationDelay: "0.2s" }}>
